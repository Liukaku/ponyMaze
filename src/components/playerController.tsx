...
const PlayerController = ({ movePlayer }: PlayerControllerProps) => {
  ...
  return (
    <div className=" shadow-black/30 sticky bottom-10 md:w-1/6 w-1/2 md:ml-1 mx-auto mt-16  border-2 pb-10 bg-gray-300 border-b-gray-500 border-l-gray-500 border-r-gray-100 border-t-gray-100 shadow-xl">
